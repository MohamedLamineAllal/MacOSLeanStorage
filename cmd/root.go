...
large cache and temporary files on macOS, specifically targeting developer tools 
like VSCode, Xcode, and browser caches like Arc and Chrome.
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".MacosLeanStorage" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("yaml")
		viper.SetConfigName(".MacosLeanStorage")
	}
