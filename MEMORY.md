...
- **Logic Refinement**: Implemented path deduplication across targets. Targets can now overlap without causing double-counting in the final global cleanup summary, using a `map` to track unique files.
